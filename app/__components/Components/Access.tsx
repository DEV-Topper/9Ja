		...
		<div className="flex flex-col sm:flex-row p-4 mt-24">
			<div className="w-full sm:w-1/2 p-4">
				...
				<p className="text-[17] text-gray-700 mb-4">
					Take your business to the next level by expanding with
					DoorDash Capital. Easy, accessible financing can help
					eligible merchants invest in new equipment, open a new
					location, hire more employees, and much more.
				</p>
			</div>
			<div className="w-full sm:w-1/2 p-4">
				<Image
